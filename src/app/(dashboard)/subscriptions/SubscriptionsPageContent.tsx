...
// /overview instead of rendering this component. Preserved here, fully wired
// to the real catalog/business APIs, so the flow can be re-enabled later —
// just have page.tsx render <SubscriptionsPageContent /> again instead of
// redirecting, and add "Subscriptions" back to the sidebar nav
