...
// The /subscriptions route (page.tsx in this folder) currently redirects to
// /overview instead of rendering this component. Preserved here, fully intact
// and functional, so the flow can be re-enabled later — just have page.tsx
// render <SubscriptionsPageContent /> again instead of redirecting, and add
// "Subscriptions" back to the sidebar nav (src/components/layout/Sidebar.tsx).
